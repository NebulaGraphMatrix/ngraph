...
class equivalence {
 ...
 public:
  ...
  typedef
      typename map<unsigned int, element_set>::const_iterator const_iterator;
  ...
  static unsigned int index(const_iterator p) { return p->first; }
  ...
  unsigned int class_size(unsigned int i) const { return S_[i].size(); }
