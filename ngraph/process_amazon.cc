...
These routines read and process the metafile of the Amazon co-purchasing
network, described in the Stanford Large Network Dataset Collection (SNAP
collection) maintained by Jure Leskovec:
...
ASIN: 1559362022
  ...
  categories: 3
   |Books[283155]|Subjects[1000]|Literature & Fiction[17]|Drama[2159]|United
States[2160] |Books[283155]|Subjects[1000]|Arts & Photography[1]|Performing
Arts[521000]|Theater[2154]|General[2218]
   |Books[283155]|Subjects[1000]|Literature & Fiction[17]|Authors, A-Z[70021]|(
B )[70023]|Bogosian, Eric[70116] reviews: total: 8  downloaded: 8  avg rating: 4
...
class amazon_record {
 public:
  ...
  amazon_record()
      : Id(0), ASIN(), title(), salesrank(0), similar(), reviews() {}
};
